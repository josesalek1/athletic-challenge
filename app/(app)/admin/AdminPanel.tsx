  ...
  return (
    <main className="wrap admin-page">
      ...
      {section === 'videos' && <section>
        ...
        <p className="muted admin-help admin-feed-help">Active members may share supported video links and delete their own posts. Administrators can edit, hide, restore or permanently delete every video.</p>
